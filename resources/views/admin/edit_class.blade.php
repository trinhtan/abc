...
<head>
	...
	<script type="text/javascript">
        ...
        var class_ = <?php echo json_encode($class); ?>;

        var all_class = <?php echo json_encode($all_class); ?>
        ...
        function checkEditClass(){
            ...
            var div = document.getElementById("editClass");
            ...
            if(ma_lop == ''){
                ...
                for(i = 0; i < all_class.length; i++){
                    ...
                    if(ma_lop == all_class[i]['ma_lop'] && all_class[i]['ma_lop'] != class_['ma_lop']){
            ...
            if(flag == 0){
                ...
                if(flag == 1){
                    ...
                    if(flag == 2){
                        ...
                        div.innerHTML = "<input type='submit' value='SỬA'>";
...
<body>
	<h1 style="text-align:center" >Sửa Lớp</h1>

	<div id="app">
  		<form class="vue-form form" action="update_class" method="get">
            <input type="hidden" name="id_class" value="<?php echo $class['id'] ?>">
    		...
    		<fieldset>
      			...
      			<div>
        			<h4>Mã Lớp</h4>
        			<input type="text" name="ma_lop" id="ma_lop" required="" v-model="name" placeholder="<?php echo $class['ma_lop']; ?>" onkeyup="checkEditClass()">
      			</div>
      			<div>
        			<h4>Học Phần</h4>
        				<p class="select">
         		 			<select class="budget" v-model="selection.member" name="id_hoc_phan">
                                    <option value="<?php echo $class['id_hoc_phan']?>"><?php echo $class['ma_hoc_phan']." - ".$class['ten_hoc_phan']; ?></option>

								<?php
									for($i = 0; $i < count($subject); $i++){

                                        if($subject[$i]['id'] == $class['id_hoc_phan']) continue;
								?>
