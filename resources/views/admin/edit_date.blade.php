...
<body>
	<div class="container" >
  		<h2>Sửa ngày thi thứ <?php echo $date[0]['ngay_thi_thu'] ?></h2>
  		<form class="form" action="update_date" method="get">

  			<input type="hidden" name="id" value="<?php echo $date[0]['id']?>"> 
	    	<fieldset class="form-fieldset ui-input __second">
	      		<input type="date" id="date" tabindex="0" onkeyup="checkAddStudent()" name="ngay" value="<?php echo $date[0]['ngay']; ?>"/>
	      		<label for="ho_ten">
	        		<span data-text="E-mail Address">Ngày Tháng</span>
	      		</label>
	    	</fieldset>
