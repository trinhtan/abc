...
<body>
	<div class="container" >
  		<h2>Thêm ngày thi thứ <?php echo $datemax ?></h2>
  		<form class="form" action="insert_date" method="get">
	    	<fieldset class="form-fieldset ui-input __second">
	      		<input type="date" id="date" tabindex="0" onkeyup="checkAddStudent()" name="date"/>
	      		<label for="ho_ten">
