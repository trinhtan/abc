...
@section('content')
            ...
            <style type="text/css">
                ...
                body{
                  ...
                  background: -o-linear-gradient(left, #283048, #859398);
...
@media (-webkit-min-device-pixel-ratio:0) {
  ...
  #xem_danh_sach_lop:hover {
    ...
    transition: .4s 0;
            ...
            <section>
                <!--for demo wrap-->
                <form action="delete_subject" method="get">
                    <h1>Danh sach hoc phan
                        <section class="links">
                            </br></br>
                            <a class="link wipe" href="add_subject">Thêm</a>
                        </section>
                    </h1>
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        ?>
                                                <tr>
                                                    <td><?php echo $i+1; ?></td>
                                                    <td><?php echo $subject[$i]['ma_hoc_phan']; ?></td>
                                                    <td><?php echo $subject[$i]['ten_hoc_phan']; ?></td>
                                                    <td>
                                                        <a id="xem_danh_sach_lop" href="list_class_by_subject?id=<?php echo $subject[$i]['id']?>">X e m</a>
                                                    </td>
                                                    <td>
                                                        <section class="links">
                                                            <a class="link underline" href="edit_subject?id=<?php echo $subject[$i]['id']; ?> " style="margin-left: -10px">Sửa</a>
                                                        </section>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <label>
                                                                <input type="checkbox" class="option-input checkbox" name="<?php echo $subject[$i]['id']?>"/>
                                                                    Xóa
                                                            </label>
                                                        </div>
                                                    </td>
