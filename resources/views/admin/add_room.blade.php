...
<head>
	...
	<script type="text/javascript">
		...
		function checkAddRoom(){
			...
			var div = document.getElementById("addRoom");
			...
			if(ten_phong == ''){
				...
				for(i = 0; i < all_room.length; i++){
					...
					if(ten_phong == all_room[i]['ten_phong']){
			...
			if( flag == 0 ){
				...
				if( flag == 1){
					...
					infor.innerHTML = "<button class='btn' type='submit'>Tên phòng đã tồn tại</button>";
					...
					if( flag == 2){
						...
						if( suc_chua != 0 && flag_suc_chua == 0){
							...
							infor.innerHTML = "<button class='btn' type='submit'>Sức chứa phải là số</button>";
						}
					}
...
<body>
	<div class="container" >
  		...
  		<h2>Thêm phòng</h2>
  		<form class="form" action="insert_room">
    
    	<fieldset class="form-fieldset ui-input __first">
      		<input type="text" id="ten_phong" tabindex="0" onkeyup="checkAddRoom()" name="ten_phong"/>
      		<label for="ma_hoc_phan">
        		<span data-text="Username">Tên Phòng</span>
      		</label>
    	</fieldset>
    
    	<fieldset class="form-fieldset ui-input __second">
      		<input type="text" id="suc_chua" tabindex="0" onkeyup="checkAddRoom()" name="suc_chua"/>
      		<label for="ten_hoc_phan">
        		<span data-text="E-mail Address">Sức Chứa</span>
      		</label>
    	</fieldset>

    <div class="form-footer" id="addRoom">
