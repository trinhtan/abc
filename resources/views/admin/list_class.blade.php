...
@section('content')
            ...
            <style type="text/css">
                ...
                body{
                  background: -webkit-linear-gradient(left, #3a6186, #89253e);
                  background: -o-linear-gradient(left, #3a6186, #89253e);
...
#xem_danh_sach_sinh_vien {
  color: blue;
  font: bold 1.2em/1.5 'Fjalla One', sans-serif;
  text-decoration: none;
  text-transform: uppercase;
  -webkit-transition: .2s;
}
#xem_danh_sach_sinh_vien:hover {
  color: hotPink;
}
                ...
                <form action="delete_class" method="get">
                    <h1>Danh sach lop
                        <section class="links">
                            ...
                            <a class="link wipe" href="add_class">Thêm</a>
                        </section>
                    </h1>
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        ?>
                                                <tr>
                                                    <td><?php echo $i+1; ?></td>
                                                    <td><?php echo $class[$i]['ma_hoc_phan']; ?></td>
                                                    <td><?php echo $class[$i]['ten_hoc_phan']; ?></td>
                                                    <td><?php echo $class[$i]['ma_lop']; ?></td>
                                                    <td>
                                                        <a id="xem_danh_sach_sinh_vien" href="list_student_by_class?id=<?php echo $class[$i]['id']?>">X e m</a>
                                                    </td>
                                                    <td>
                                                        <section class="links">
                                                            <a class="link underline" href="edit_class?id=<?php echo $class[$i]['id']; ?> " style="margin-left: -10px">Sửa</a>
                                                        </section>
                                                    </td>
                                                    <td>
                                                        <div>
                                                            <label>
                                                                <input type="checkbox" class="option-input checkbox" name="<?php echo $class[$i]['id']?>"/>
                                                                    Xóa
                                                            </label>
                                                        </div>
                                                    </td>
