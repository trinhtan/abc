...
input#s:focus + .close span.back{
	...
	<body>
		...
		<div class="lich_thi">
			...
			<h1 id="table"><span class="blue"></span>Lịch Thi Của Sinh Viên <?php echo $student['ho_ten']; ?><span class="blue"></span></h1>
			<h2>Created with love by <a href="http://pablogarciafernandez.com" target="_blank">Trịnh Văn Tân</a></h2>

			<form action ="search" method="get">
				<div class="search-box">
					<div class="searchform" style="margin-left: -30px">
					    <input name="ma_sinh_vien" id="s" type="text" placeholder="Nhập mã sinh viên"/>    
					    <div class="close">
			...
			<table class="container">
				<thead>
					<tr>
						...
						<th><h1>Lớp</h1></th>
						<th><h1>Nhóm</h1></th>
						<th><h1>Tên Học Phần</h1></th>
						<th><h1>Mã Học Phần</h1></th>
						<th><h1>Danh sách sinh viên</h1></th>
						<th><h1>Kíp</h1></th>
						<th><h1>Ngày</h1></th>
						<th><h1>Phòng</h1></th>
					</tr>
				...
				<tbody>
					...
					<tr>
						<td><?php echo $i; ?></td>
						<td><?php echo $nhom[$i]['ma_lop']; ?></td>
						<td><?php echo $nhom[$i]['nhom']; ?></td>
						<td><?php echo $nhom[$i]['ten_hoc_phan'];?></td>
						<td><?php echo $nhom[$i]['ma_hoc_phan'];?></td>
						<td>
                            <a id="xem_danh_sach_sinh_vien" href="list_student_by_group_home?id_group=<?php echo $nhom[$i]['id']?>">X e m
                            </a>
                        </td>
						<td><?php echo $nhom[$i]['kip'];?></td>
						<td><?php echo $nhom[$i]['ngay']; ?></td>
						<td><?php echo $nhom[$i]['ten_phong'];?></td>
					</tr>
					<?php
					}
					?>
